...
Agentic 1.1.11 is the current public release, reconciled against npm, both GitHub release channels, source tags, checksums, and the public installer.

| Product | Version | Published platform |
|---|---:|---|
| CLI / npm | `@chunklib/agentic@1.1.11` | npm plus a formal macOS arm64 CLI GitHub Release |
| Agentic VS Code Extension | `1.1.11` | Checksum-protected CLI Release asset; not published to Marketplace/Open VSX |
| Agentic Desktop | `1.1.11` | Formal macOS arm64 ad-hoc signed, non-notarized DMG and ZIP packages |
...
The published platform list describes the verified 1.1.11 scope. It is not a claim that other operating systems or architectures passed the same release gates.
...
npm install --global @chunklib/agentic@1.1.11
agentic --version
```

The CLI GitHub binary channel is separate from npm. Agentic 1.1.11 is available in the [current platform-limited formal Agentic CLI Release](https://github.com/chunklib/agentic-releases/releases/tag/v1.1.11); npm remains the portable installation path.
...
The Agentic 1.1.11 VSIX is available as a checksum-protected asset in the current formal CLI GitHub Release. It is not published to Marketplace or Open VSX. JetBrains IDEs that expose ACP configuration can launch Agentic with command `agentic` and argument `acp`; no separate JetBrains plugin is required.
