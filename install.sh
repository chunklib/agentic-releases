...
echo ""
echo "   Optional — lightweight memory plugin:"
echo "     Add \"opencode-working-memory\" to the standard plugin array in $CFG_FILE."
echo "     Agentic 1.0 does not embed a private memory runtime; plugin lifecycle and storage stay external."
